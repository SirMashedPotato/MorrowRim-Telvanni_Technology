...
namespace MorrowRim_Telvanni
{
	...
	public class Designator_DestroyGolem : Designator
	{
		...
		protected override DesignationDef Designation
		{
			get
			{
				return DesignationDefOf.MorrowRim_DestroyGolem;
			}
		}

		// Token: 0x06005C16 RID: 23574 RVA: 0x001E9D78 File Offset: 0x001E7F78
		public Designator_DestroyGolem()
		{
			this.defaultLabel = "MorrowRim_DesignatorDestroyGolem".Translate();
			this.defaultDesc = "MorrowRim_DesignatorDestroyGolemDesc".Translate();
			this.icon = ContentFinder<Texture2D>.Get("UI/Designators/MorrowRim_DestroyGolem", true);
		...
		public override AcceptanceReport CanDesignateCell(IntVec3 c)
		{
			...
			{
				return "MorrowRim_MessageMustDesignateGolemDestroy".Translate();
			}
			return true;
		}
		...
		{
			Pawn pawn = t as Pawn;
			if (pawn != null && GolemUtility.IsGolem(pawn) && pawn.Faction == Faction.OfPlayer && base.Map.designationManager.DesignationOn(pawn, this.Designation) == null && !pawn.InAggroMentalState)
			{
				return true;
			}
			return false;
