                    ...
                    if (hashSet != null)
                    {
                        foreach (Thing thing in hashSet)
                        {
                            ...
                            if (thing != null && thing is Pawn)
                            {
                                ...
                                if (!p.RaceProps.IsFlesh || p.health.hediffSet.GetFirstHediffOfDef(HediffDefOf.MorrowRim_ElixirActiveParalysis_High) != null)
                                {
                                    return;
                                }
                                ...
                                if (num != 0f && !this.Destroyed)
                                {
                                    ...
                                    num *= num2;
                                    HealthUtility.AdjustSeverity(p, HediffDefOf.MorrowRim_StaveParalysis, num);
                                }
                            }
                        }
                    }
