...
namespace MorrowRim_Telvanni
{
	class JobGiver_Flick : ThinkNode_JobGiver
	{
		...
		{
			return pawn.Map.designationManager.DesignationOn(t, RimWorld.DesignationDefOf.Flick) != null && pawn.CanReserve(t, 1, -1, null, forced) && ForbidUtility.InAllowedArea(t.Position, pawn);
		}
