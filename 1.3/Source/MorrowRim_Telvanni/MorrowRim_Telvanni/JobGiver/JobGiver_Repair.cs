...
namespace MorrowRim_Telvanni
{
	class JobGiver_Repair : ThinkNode_JobGiver
	{
		...
		public bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			...
			return pawn.CanReserve(building, 1, -1, null, forced) && building.Map.designationManager.DesignationOn(building, RimWorld.DesignationDefOf.Deconstruct) == null && (!building.def.mineable || building.Map.designationManager.DesignationAt(building.Position, RimWorld.DesignationDefOf.Mine) == null) && !building.IsBurning();
		}

		public Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			return JobMaker.MakeJob(JobDefOf.MorrowRim_ServantRepair, t);
		}
